...
- 缓存版本号：`20260908-18`
- 模块数：30 个业务模块（`js/modules/`）+ 6 个核心文件（`js/core/`）
...
| 我的课程 | `#courses` | 深交互 | 课程卡片筛选排序、创建课程向导、教材上传与解析信息流 |
...
| **教学大纲** | `#course/syllabus` | **深交互** | 见下节「教学大纲演示」 |
| 教学日历 | `#course/calendar` | 深交互 | 16 周教学内容总表 + 排课日历 + AI 助手（多层历史增强） |
| 备课工作台 | `#course/preparation` | 深交互 | 备课单元、Markdown 教案编辑、划词 AI、学术资料 |
| 课件制作 | `#course/courseware` | 深交互 | 章节卡片 → PPT 三栏画布 + 讲义，页面元素化编辑 |
| 作业管理 | `#course/assignment` | 深交互 | 题目为最小维护单位、新建/编辑/AI 生成/检查/预览 |
| 学生画像 | `#course/students` | 深演示 | 班级概况 / 学生分析 / 内容掌握 / 教学建议（Mock 聚合数据） |
| 试卷管理 | `#course/exam` | 占位 | 基础表格（正式试卷需教秘审核流程后补） |
